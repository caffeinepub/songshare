...
export class Backend implements backendInterface {
    ...
    async getSongsByGenre(arg0: string): Promise<Array<Song>> {
        if (this.processError) {
            try {
                const result = await this.actor.getSongsByGenre(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTopSongs(arg0: bigint): Promise<Array<Song>> {
        if (this.processError) {
            try {
                const result = await this.actor.getTopSongs(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async likeSong(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async submitSong(arg0: string, arg1: string, arg2: string, arg3: string, arg4: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.submitSong(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
